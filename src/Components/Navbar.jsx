                    ...
                    <div className="grid grid-cols-1 gap-4 p-4">
                        ...
                        {activeSubmenu === 'Venues' && (
                          <div className="absolute left-full top-0 mt-0 ml-2 w-64 bg-gray-900 border rounded shadow-lg">
                            <ul className="pl-4 py-2">
                              <li className="py-1"><Link to="/Career" className="text-gray-300 hover:text-white">Banquet Halls</Link></li>
                              ...
                              <li className="py-1"><Link to="/Career" className="text-gray-300 hover:text-white">Wedding Hotels</Link></li>
                            </ul>
                          </div>
                        )}
                      </div>
                      ...
                      <div onMouseEnter={() => handleSubmenu('Food')} onClick={() => handleSubmenu(null)} className="relative">
                        ...
                        {activeSubmenu === 'Food' && (
                          <div className="absolute left-full top-0 mt-0 ml-2 w-64 bg-gray-900 border rounded shadow-lg">
                            <ul className="pl-4 py-2">
                              <li className="py-1"><Link to="/Career" className="text-gray-300 hover:text-white">Catering Services</Link></li>
                              <li className="py-1"><Link to="/Career" className="text-gray-300 hover:text-white">Snacks & Food Stalls</Link></li>
                            </ul>
                          </div>
                        )}
                      </div>
                        ...
                        {activeSubmenu === 'Entertainment' && (
                          <div className="absolute left-full top-0 mt-0 ml-2 w-64 bg-gray-900 border rounded shadow-lg">
                            <ul className="pl-4 py-2">
                              ...
                              <li className="py-1"><Link to="/Career" className="text-gray-300 hover:text-white">Choreographer</Link></li>
